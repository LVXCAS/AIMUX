...
const APP_TOOLTIP: &str = "Try the **AIMUX App**. Run ‘aimux app’ or visit https://chatgpt.com/codex?app-landing-page=true";
const FAST_TOOLTIP: &str =
    "*New* Use **/fast** to enable our fastest inference with increased plan usage.";
const OTHER_TOOLTIP: &str = "*New* Build faster with the **AIMUX App**. Run ‘aimux app’ or visit https://chatgpt.com/codex?app-landing-page=true";
const OTHER_TOOLTIP_NON_MAC: &str = "*New* Build faster with AIMUX.";
const FREE_GO_TOOLTIP: &str =
    "*New* For a limited time, AIMUX is included in your plan for free – let’s build together.";
...
/// Pick a random tooltip to show to the user when starting AIMUX.
...
[[announcements]]
content = "Welcome to AIMUX! Check out the new onboarding flow."
